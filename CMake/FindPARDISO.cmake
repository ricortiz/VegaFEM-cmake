...
#     SET( MKLSOLVER_LIBRARIES ${AUX1} ${AUX2} ${AUX3} ${AUX4}  ${AUX7} ${AUX5} ${AUX6} ${AUX8}  ${AUX9}  )
    ...
    message(STATUS "MKL solver libraries found: ${MKLSOLVER_LIBRARIES}")
  ELSE(AUX1)
    message(WARNING "Finding MKLSOLVER library failed, please try to set the var MKLSOLVER_ROOT_DIR")
  ENDIF(AUX1)
ELSE(MKLSOLVER_INCLUDE_DIR)
  message(WARNING "Finding MKLSOLVER includes failed, please try to set the var MKLSOLVER_ROOT_DIR")
